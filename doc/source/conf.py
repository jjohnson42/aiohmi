# -*- coding: utf-8 -*-
#
# aiohmi documentation build configuration file, created by
...
latex_documents = [
    ('index', 'aiohmi.tex', u'aiohmi Documentation',
...
man_pages = [
    ('index', 'aiohmi', u'aiohmi Documentation',
